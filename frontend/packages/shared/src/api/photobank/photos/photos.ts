...
export type photosSearchPhotosResponseSuccess =
  photosSearchPhotosResponse200 & {
    headers: Headers;
  };
export type photosSearchPhotosResponseError = photosSearchPhotosResponse400 & {
  headers: Headers;
};

export type photosSearchPhotosResponse =
  | photosSearchPhotosResponseSuccess
  | photosSearchPhotosResponseError;
...
export type photosGetPhotoResponseSuccess = photosGetPhotoResponse200 & {
  headers: Headers;
};
export type photosGetPhotoResponseError = photosGetPhotoResponse404 & {
  headers: Headers;
};

export type photosGetPhotoResponse =
  | photosGetPhotoResponseSuccess
  | photosGetPhotoResponseError;
...
export type photosUploadResponseSuccess = photosUploadResponse200 & {
  headers: Headers;
};
export type photosUploadResponse = photosUploadResponseSuccess;
...
export type photosGetDuplicatesResponseSuccess =
  photosGetDuplicatesResponse200 & {
    headers: Headers;
  };
export type photosGetDuplicatesResponse = photosGetDuplicatesResponseSuccess;
