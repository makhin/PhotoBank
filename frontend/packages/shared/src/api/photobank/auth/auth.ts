...
export type authGetUserResponse = authGetUserResponseSuccess;
...
export type authUpdateUserResponseError = authUpdateUserResponse400 & {
  headers: Headers;
};

export type authUpdateUserResponse =
  | authUpdateUserResponseSuccess
  | authUpdateUserResponseError;
...
export type authGetTelegramSubscriptionsResponseSuccess =
  authGetTelegramSubscriptionsResponse200 & {
    headers: Headers;
  };
export type authGetTelegramSubscriptionsResponseError =
  authGetTelegramSubscriptionsResponse401 & {
    headers: Headers;
  };

export type authGetTelegramSubscriptionsResponse =
  | authGetTelegramSubscriptionsResponseSuccess
  | authGetTelegramSubscriptionsResponseError;
...
export type authTelegramExchangeResponseSuccess =
  authTelegramExchangeResponse200 & {
    headers: Headers;
  };
export type authTelegramExchangeResponseError = (
...
export type authTelegramExchangeResponse =
  | authTelegramExchangeResponseSuccess
  | authTelegramExchangeResponseError;
...
export type authGetEffectiveResponseSuccess = authGetEffectiveResponse200 & {
  headers: Headers;
};
export type authGetEffectiveResponse = authGetEffectiveResponseSuccess;
