...
export const usersGetAll = (
  ...
  return customInstance<UserDto[]>(
    { url: `/api/admin/users`, method: 'GET', params, ...(signal ? { signal } : {}) },
    options
  );
};
...
>(
  params?: UsersGetAllParams,
  options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof usersGetAll>>, TError, TData>;
...
export const useUsersCreate = <TError = ProblemDetails, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof usersCreate>>,
    TError,
    { data: CreateUserDto },
...
export const useUsersUpdate = <TError = ProblemDetails, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof usersUpdate>>,
    TError,
    { id: string; data: UpdateUserDto },
...
export const useUsersDelete = <TError = ProblemDetails, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof usersDelete>>,
    TError,
    { id: string },
...
export const useUsersResetPassword = <TError = ProblemDetails, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof usersResetPassword>>,
    TError,
    { id: string; data: ResetPasswordDto },
...
export const useUsersSetRoles = <TError = ProblemDetails, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof usersSetRoles>>,
    TError,
    { id: string; data: SetRolesDto },
