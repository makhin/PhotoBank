...
export const personGroupsGetAll = (
  ...
  return customInstance<PersonGroupDto[]>(
    { url: `/api/persongroups`, method: 'GET', ...(signal ? { signal } : {}) },
    options
  );
};
...
export const getPersonGroupsGetAllQueryOptions = <
  ...
  TError = unknown
>(options?: {
  query?: UseQueryOptions<Awaited<ReturnType<typeof personGroupsGetAll>>, TError, TData>;
...
export const usePersonGroupsCreate = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof personGroupsCreate>>,
    TError,
    { data: PersonGroupDto },
...
export const usePersonGroupsUpdate = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof personGroupsUpdate>>,
    TError,
    { groupId: number; data: PersonGroupDto },
...
export const usePersonGroupsDelete = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof personGroupsDelete>>,
    TError,
    { groupId: number },
...
export const personGroupsAddPerson = (
  ...
  return customInstance<void>(
    {
      url: `/api/persongroups/${groupId}/persons/${personId}`,
      method: 'POST',
      ...(signal ? { signal } : {}),
    },
    options
...
export const usePersonGroupsAddPerson = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof personGroupsAddPerson>>,
    TError,
    { groupId: number; personId: number },
...
export const usePersonGroupsRemovePerson = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof personGroupsRemovePerson>>,
    TError,
    { groupId: number; personId: number },
