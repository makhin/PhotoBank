...
YOLOv8 использует **channels-first (CHW)** layout для выходных данных:

**Формат выхода**: `[1, 84, 8400]`
- `1` - batch size
- `84` - каналы (4 bbox координаты + 80 классов)
...
Это **channels-first** layout, **НЕ** row-major layout! Неправильная интерпретация приведет к бессмысленным детекциям.
